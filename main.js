...
async function SelectionSort(delay = 9000) {
...
document.getElementById("Button1").style.backgroundColor = "#459e5b";

// To enable the button "Bubble Sort" after final(sorted)
document.getElementById("Button2").disabled = false;
document.getElementById("Button2").style.backgroundColor = "#646464";

// To enable the button "Selection Sort" after final(sorted)
document.getElementById("Button3").disabled = false;
document.getElementById("Button3").style.backgroundColor = "#646464";

// To enable the button "Merge Sort" after final(sorted)
document.getElementById("Button4").disabled = false;
document.getElementById("Button4").style.backgroundColor = "#646464";

// To enable the button "Insertion Sort" after final(sorted)
document.getElementById("Button5").disabled = false;
document.getElementById("Button5").style.backgroundColor = "#646464";
}
...
document.getElementById("Button1").style.backgroundColor = "#ff4d00";
